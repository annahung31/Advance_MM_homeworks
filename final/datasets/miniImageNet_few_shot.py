...
class SimpleDataset:
    def __init__(self, transform, target_transform=identity):
        ...
        json_path = miniImageNet_path + 'train.json'
...
class SetDataset:
    def __init__(self, batch_size, transform, mode='train'):
        json_path = miniImageNet_path + mode + '.json'
...
class SimpleDataManager(DataManager):
    ...
    def get_data_loader(self, aug, data_file=None): #parameters that would change on train/val set
...
class SetDataManager(DataManager):
    def __init__(self, image_size, mode='train', n_way=5, n_support=5, n_query=16, n_eposide = 100):        
