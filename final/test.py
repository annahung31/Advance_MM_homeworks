...
if __name__ == '__main__':
  ...
  if 'Conv' in params.model:
    ...
    image_size = 224
  split = params.split
  loadfile = os.path.join(params.data_dir, params.dataset, 'LFT',  split + '.json')
  ...
  checkpoint_dir = '%s/checkpoints/%s/%s_%s' %(params.save_dir, 'single', params.model, params.method)
  ...
  if params.method == 'protonet':
    ...
    model = MyMethod(model_dict[params.model], **few_shot_params)
